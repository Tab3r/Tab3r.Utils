...
namespace Java.To.Net
{
    ...
    [Serializable]
    public class HashMap<TKey, TValue> : Map<TKey, TValue> // IDictionary<TKey, TValue>
    {
        ...
        public virtual void putAll(Map<TKey, TValue> map)
        {
            // Can do the trick???
            this._dict = ((HashMap<TKey, TValue>)map)._dict;
        }
